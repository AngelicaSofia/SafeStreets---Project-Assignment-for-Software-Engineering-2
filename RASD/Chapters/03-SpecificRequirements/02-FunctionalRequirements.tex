...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/1.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/3.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/4.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/5.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/6.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/7.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[origin=c,width=\textwidth]{RASD_Images/SequenceDiagrams/8.jpg}
